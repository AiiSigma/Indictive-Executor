...
final Color primaryDark  = const Color(0xFF2F1515); // maron utama (background)
final Color primaryBlue  = const Color(0xFF4A2323); // maron medium (appbar / base)
final Color accentBlue   = const Color(0xFF6A3434); // maron aksen
final Color lightBlue    = const Color(0xFFC26A6A); // merah maron terang (icon / highlight)
final Color cardDark     = const Color(0xFF3F1E1E); // card maron
final Color cardDarker   = const Color(0xFF261010); // card lebih gelap dikit
