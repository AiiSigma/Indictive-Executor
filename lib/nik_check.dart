...
final Color primaryDark    = const Color(0xFF2E1515); // background utama (maron gelap)
final Color primaryBlue    = const Color(0xFF4A2323); // maron medium (base)
final Color accentBlue     = const Color(0xFF6A3434); // maron aksen / border
final Color lightBlue      = const Color(0xFFC26A6A); // maron terang (icon / highlight)
final Color cardDark       = const Color(0xFF3F1E1E); // card maron
final Color cardDarker     = const Color(0xFF261010); // card maron lebih dalam

// Status colors → tetap merah maron
final Color successGreen   = const Color(0xFF7A3A3A); // success → maron tenang
final Color warningOrange  = const Color(0xFF8C4A4A); // warning → maron hangat
final Color dangerRed      = const Color(0xFF5A2A2A); // danger → maron gelap jelas
